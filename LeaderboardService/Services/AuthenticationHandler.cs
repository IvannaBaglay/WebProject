...
namespace LeaderboardService.Services
{
    public class AuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        {
            AuthenticationServiceUri = new Uri(configuration.GetConnectionString("AuthenticationService"));
        }
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            var claims = new[] { new Claim(ClaimTypes.Name, GetLoginFromToken(authVal.Substring("Bearer ".Length).Trim())) };
        ...
        string GetLoginFromToken(string token)
        {
            ...
            return DecodedToken.Claims.Where(claim => claim.Type == ClaimTypes.Name).FirstOrDefault()?.Value;
        }
    }
}
